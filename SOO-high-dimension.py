...
def tree_depth(node):
    ...
    return dep[dindex]
class Node:
    def __init__(self, x1center=None, x2center=None, depth=None,x1leftmin=None, x1rightmax=None,x2leftmin=None,
    x2rightmax=None, parent = None):
    ...
    def Addnode(self,x1center,x2center,depth,x1leftmin,x1rightmax,x2leftmin,x2rightmax):
...
def SOO():
    rootnode = Node(x1center=0.5,x2center=-1, depth=0,x1leftmin=-1, x1rightmax=2,x2leftmin=-3,x2rightmax=1)
    current_node=[]
