            ...
            if h in check_leaves:
                ...
                if ini_f>=v_max:
                    ...
                    if width_index==0:
                        ...
                        centerx31,centerx32,centerx33=split3(e3,e4,node.x2leftmin,node.x2rightmax,node.x3leftmin,node.x3rightmax)
                        centerx41,centerx42,centerx43=split3(e4,e5,node.x2leftmin,node.x2rightmax,node.x3leftmin,node.x3rightmax)
                        centerx51,centerx52,centerx53=split3(e5,e6,node.x2leftmin,node.x2rightmax,node.x3leftmin,node.x3rightmax)
                        centerx61,centerx62,centerx63=split3(e6,e7,node.x2leftmin,node.x2rightmax,node.x3leftmin,node.x3rightmax)
                        centerx71,centerx72,centerx73=split3(e7,e8,node.x2leftmin,node.x2rightmax,node.x3leftmin,node.x3rightmax)
                        centerx81,centerx82,centerx83=split3(e8,node.x1rightmax,node.x2leftmin,node.x2rightmax,node.x3leftmin,node.x3rightmax)
                        ...
                        current_node.append(node.Addnode(value3,centerx31,centerx32, centerx33, node.depth+1,e3,e4,node.x2leftmin,node.x2rightmax,node.x3leftmin,node.x3rightmax))
                        current_node.append(node.Addnode(value4,centerx41,centerx42, centerx43, node.depth+1,e4,e5,node.x2leftmin,node.x2rightmax,node.x3leftmin,node.x3rightmax))
                        current_node.append(node.Addnode(value5,centerx51,centerx52, centerx53, node.depth+1,e5,e6,node.x2leftmin,node.x2rightmax,node.x3leftmin,node.x3rightmax))
                        current_node.append(node.Addnode(value6,centerx61,centerx62, centerx63, node.depth+1,e6,e7,node.x2leftmin,node.x2rightmax,node.x3leftmin,node.x3rightmax))
                        current_node.append(node.Addnode(value7,centerx71,centerx72, centerx73, node.depth+1,e7,e8,node.x2leftmin,node.x2rightmax,node.x3leftmin,node.x3rightmax))
                        current_node.append(node.Addnode(value8,centerx81,centerx82, centerx83, node.depth+1,e8,node.x1rightmax,node.x2leftmin,node.x2rightmax,node.x3leftmin,node.x3rightmax))
                    ...
                    if width_index==2:
                        ...
                        centerx31,centerx32,centerx33=split3(node.x1leftmin,node.x1rightmax,node.x2leftmin,node.x2rightmax,e3,e4)
                        centerx41,centerx42,centerx43=split3(node.x1leftmin,node.x1rightmax,node.x2leftmin,node.x2rightmax,e4,e5)
                        centerx51,centerx52,centerx53=split3(node.x1leftmin,node.x1rightmax,node.x2leftmin,node.x2rightmax,e5,e6)
                        centerx61,centerx62,centerx63=split3(node.x1leftmin,node.x1rightmax,node.x2leftmin,node.x2rightmax,e6,e7)
                        centerx71,centerx72,centerx73=split3(node.x1leftmin,node.x1rightmax,node.x2leftmin,node.x2rightmax,e7,e8)
                        centerx81,centerx82,centerx83=split3(node.x1leftmin,node.x1rightmax,node.x2leftmin,node.x2rightmax,e8,node.x3rightmax)
                        ...
                        current_node.append(node.Addnode(value3,centerx31,centerx32, centerx33, node.depth+1,node.x1leftmin,node.x1rightmax,node.x2leftmin,node.x2rightmax,e3,e4))
                        current_node.append(node.Addnode(value4,centerx41,centerx42, centerx43, node.depth+1,node.x1leftmin,node.x1rightmax,node.x2leftmin,node.x2rightmax,e4,e5))
                        current_node.append(node.Addnode(value5,centerx51,centerx52, centerx53, node.depth+1,node.x1leftmin,node.x1rightmax,node.x2leftmin,node.x2rightmax,e5,e6))
                        current_node.append(node.Addnode(value6,centerx61,centerx62, centerx63, node.depth+1,node.x1leftmin,node.x1rightmax,node.x2leftmin,node.x2rightmax,e6,e7))
                        current_node.append(node.Addnode(value7,centerx71,centerx72, centerx73, node.depth+1,node.x1leftmin,node.x1rightmax,node.x2leftmin,node.x2rightmax,e7,e8))
                        current_node.append(node.Addnode(value8,centerx81,centerx82, centerx83, node.depth+1,node.x1leftmin,node.x1rightmax,node.x2leftmin,node.x2rightmax,e8,node.x3rightmax))
                    ...
                    if width_index==1:
                        ...
                        centerx31,centerx32,centerx33=split3(node.x1leftmin,node.x1rightmax,e3,e4,node.x3leftmin,node.x3rightmax)
                        centerx41,centerx42,centerx43=split3(node.x1leftmin,node.x1rightmax,e4,e5,node.x3leftmin,node.x3rightmax)
                        centerx51,centerx52,centerx53=split3(node.x1leftmin,node.x1rightmax,e5,e6,node.x3leftmin,node.x3rightmax)
                        centerx61,centerx62,centerx63=split3(node.x1leftmin,node.x1rightmax,e6,e7,node.x3leftmin,node.x3rightmax)
                        centerx71,centerx72,centerx73=split3(node.x1leftmin,node.x1rightmax,e7,e8,node.x3leftmin,node.x3rightmax)
                        centerx81,centerx82,centerx83=split3(node.x1leftmin,node.x1rightmax,e8,node.x2rightmax,node.x3leftmin,node.x3rightmax)
                        ...
                        current_node.append(node.Addnode(value3,centerx31,centerx32, centerx33, node.depth+1,node.x1leftmin,node.x1rightmax,e3,e4,node.x3leftmin,node.x3rightmax))
                        current_node.append(node.Addnode(value4,centerx41,centerx42, centerx43, node.depth+1,node.x1leftmin,node.x1rightmax,e4,e5,node.x3leftmin,node.x3rightmax))
                        current_node.append(node.Addnode(value5,centerx51,centerx52, centerx53, node.depth+1,node.x1leftmin,node.x1rightmax,e5,e6,node.x3leftmin,node.x3rightmax))
                        current_node.append(node.Addnode(value6,centerx61,centerx62, centerx63, node.depth+1,node.x1leftmin,node.x1rightmax,e6,e7,node.x3leftmin,node.x3rightmax))
                        current_node.append(node.Addnode(value7,centerx71,centerx72, centerx73, node.depth+1,node.x1leftmin,node.x1rightmax,e7,e8,node.x3leftmin,node.x3rightmax))
                        current_node.append(node.Addnode(value8,centerx81,centerx82, centerx83, node.depth+1,node.x1leftmin,node.x1rightmax,e8,node.x2rightmax,node.x3leftmin,node.x3rightmax))
